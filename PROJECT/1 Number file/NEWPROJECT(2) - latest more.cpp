...
{
public:
  void setCourseInfo(string cName = " ",int coursemarks, string cNo = 0 , int credits = 0);
 ...
 void setAttendance(string courseID , string ROLLNOO);
...
void courseType::setCourseInfo(string cName = " ",int coursemarks, string cNo = 0 , int credits = 0)
{
  courseName = cName;
...
void courseType::setAttendance(string courseID , string ROLLNOO)
{
  int i;
